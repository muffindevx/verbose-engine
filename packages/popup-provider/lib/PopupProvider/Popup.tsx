...
const Popup = forwardRef<RefObject<HTMLElement>, PopupProps>(
  ({ id, title, contentComponent, defaultPosition, onClose }, ref) => {
    const parentRef = useRef(ref);
    function handleClose() {
      onClose(id);
    }

    console.log('render', id, title);
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="p-4 md:p-5 space-y-4">{contentComponent}</div>
        </div>
      </Rnd>
    );
  },
